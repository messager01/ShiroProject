    ...
    <script>
        $(function () {
            ...
            $("#loginBtn").click(function () {
                ...
                //发送请求 登录认证      表单序列化传值
                /*
                * Ajax发送请求  是没有办法跳转到服务器当中的请求
                * 只能通过浏览器当中来跳转
                * */
                $.post("/login",$("form").serialize(),function (data) {   //  shiro  默认会取username和password
                    console.log(data);
                    // 把json字符串变为json对象
                    data = $.parseJSON(data);
                    if (data.success){
                ...
                <div class="lg-box">
                    ...
                    <form>
                        <div class="lg-username input-item clearfix">
                            <i class="iconfont"></i>
                            <input type="text" value="legion" name="username" placeholder="请用户名">
                        </div>
                        <div class="lg-password input-item clearfix">
                            <i class="iconfont"></i>
                            <input type="password" value="spx040610" name="password"  placeholder="请输入密码">
                        </div>
